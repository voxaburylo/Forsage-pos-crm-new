      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="text-xs text-slate-600">
            Копія створюється автоматично раз на добу; зберігаються останні 14.
            Якщо база пошкодиться, каса відновиться з найсвіжішої копії сама —
            відкат руками потрібен лише коли треба повернутися до конкретного дня.
          </p>
        </div>
        <Button
          type="button"
      ...
      <ConfirmDialog
        ...
        message={pendingRestore
          ? `Каса повернеться до стану на ${formatMoment(pendingRestore.createdAt)}. `
            + 'Робота, зроблена після цього моменту і ще не відправлена на сервер, '
