...
const STATIC: StaticCmd[] = [
  ...
  { label: 'Складські операції', icon: <Package size={16} />, to: '/inventory', group: 'Перейти', roles: ['owner', 'admin', 'manager', 'cashier', 'storekeeper'], keywords: 'ревізія списання переміщення резерв' },
