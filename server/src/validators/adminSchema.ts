...
export const settingsSchema = z.object({
  ...
  price_rounding_enabled:    z.boolean().optional(),
  price_rounding_step:       z.union([z.literal(50), z.literal(100), z.literal(500), z.literal(1000)]).optional(),
  price_rounding_dir:        z.enum(['up', 'down', 'nearest']).optional(),
