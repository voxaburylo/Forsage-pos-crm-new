-- ============================================================
-- E-2: process_sale_v2 — POS перевіряє резерви
-- Ідентична process_sale, але замість qty_on_hand перевіряє
-- qty_available = qty_on_hand - активні резерви.
-- Стара process_sale НЕ ЗМІНЮЄТЬСЯ (відкат = env-flag).
-- ============================================================
...
BEGIN
    ...
    FOR v_item IN SELECT * FROM jsonb_array_elements(p_items) LOOP
        ...
        -- Активні резерви на цей товар (без резервів поточного продажу)
