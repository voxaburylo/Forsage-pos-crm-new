-- 031_update_process_sale_split.sql
-- Оновлюємо process_sale: додаємо p_cash_amount та p_card_amount
...
BEGIN
    ...
    INSERT INTO sales (tenant_id,sale_number,customer_id,cashier_id,shift_id,status,subtotal,discount,total,payment_method,is_debt,notes,manager_id,cash_amount,card_amount)
    VALUES (p_tenant_id,v_sale_number,p_customer_id,p_cashier_id,p_shift_id,'completed',v_subtotal,p_discount,v_total,p_payment_method,p_payment_method='debt',p_notes,p_manager_id,p_cash_amount,p_card_amount)
