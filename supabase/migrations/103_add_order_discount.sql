-- Migration 103: Add discount_amount to customer_orders and update complete_customer_order

-- 1. Add discount_amount to customer_orders
ALTER TABLE customer_orders
    ADD COLUMN IF NOT EXISTS discount_amount INTEGER NOT NULL DEFAULT 0;

-- 2. Update complete_customer_order RPC to support discount_amount
...
BEGIN
    ...
    INSERT INTO sales (
        ...
        'completed', v_subtotal, v_discount, GREATEST(0, v_subtotal - v_discount),
